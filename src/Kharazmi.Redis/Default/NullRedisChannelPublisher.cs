...
{
    internal class NullRedisChannelPublisher : IChannelPublisher, INullInstance
    {
        public Task<Result> PublishAsync<TEvent>(
            ...
            => Task.FromResult(Result.Fail("Can't resolve implementation service of IChannelPublisher"));
    }
}